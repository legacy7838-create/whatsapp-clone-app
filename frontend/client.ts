...
export namespace chat {
    ...
    export class ServiceClient {
         ...
         */
        public async get(params: { id: string }): Promise<ResponseType<typeof api_chat_get_get>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/chat/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
         ...
         */
        public async list(): Promise<ResponseType<typeof api_chat_list_list>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/chat`, {method: "GET", body: undefined})
...
export namespace message {
    ...
    export class ServiceClient {
        ...
        public async list(params: RequestType<typeof api_message_list_list>): Promise<ResponseType<typeof api_message_list_list>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/message`, {query, method: "GET", body: undefined})
        ...
        public async send(params: RequestType<typeof api_message_send_send>): Promise<ResponseType<typeof api_message_send_send>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/message`, {method: "POST", body: JSON.stringify(params)})
        ...
        public async stream(params: RequestType<typeof api_message_stream_stream>): Promise<StreamIn<StreamResponse<typeof api_message_stream_stream>>> {
            ...
            return await this.baseClient.createStreamIn(`/message/stream`, {query})
        }
    }
}
...
export namespace user {
    ...
    export class ServiceClient {
        ...
        public async search(params: RequestType<typeof api_user_search_search>): Promise<ResponseType<typeof api_user_search_search>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/user/search`, {query, method: "GET", body: undefined})
