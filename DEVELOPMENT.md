...
```bash
git remote add encore encore://whatsapp-clone-app-xvpi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/whatsapp-clone-app-xvpi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/whatsapp-clone-app-xvpi/settings/integrations/github)
